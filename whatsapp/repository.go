...
type Repository interface {
	...
	Save_Tenant_details(ctx context.Context, domain_uuid string, appId string, appKey string, appSecret string, WhatsappIntegrationID string, fbIntegrationId string, twilioIntegrationId string) (*models.Response, error)
	Get_Tenant_appId(ctx context.Context, domain_uuid string) (*models.Response, error)
	Update_Tenant_details(ctx context.Context, domain_uuid string, appId string, appKey string, appSecret string, WhatsappIntegrationID string, fbIntegrationId string, twilioIntegrationId string) (*models.Response, error)
	Delete_Tenant_details(ctx context.Context, domain_uuid string) (*models.Response, error)
