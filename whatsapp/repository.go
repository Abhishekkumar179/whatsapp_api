...
type Repository interface {
	...
	Create_Queue(ctx context.Context, Id int64, Queue_uuid string, Map_with string, Name string, IntegrationID string) (*models.Response, error)
	Assign_Agent_To_Queue(ctx context.Context, agent_name string, agent_uuid string, queue_name string, tenant_domain_uuid string) (*models.Response, error)
