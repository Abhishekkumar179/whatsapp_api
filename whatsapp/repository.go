...
type Repository interface {
	...
	Add_Whatsapp_configuration(ctx context.Context, domain_uuid string, appId string, appKey string, appSecret string, WhatsappIntegrationID string, WorkingHourStartTime string, WorkingHourEndTime string, workingDays string) (*models.Response, error)
	...
	Add_Facebook_configuration(ctx context.Context, domain_uuid string, appId string, appKey string, appSecret string, FacebookIntegrationId string, WorkingHourStartTime string, WorkingHourEndTime string, workingDays string) (*models.Response, error)
