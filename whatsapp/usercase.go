...
type Usecase interface {
	...
	Save_Tenant_details(ctx context.Context, flow map[string]interface{}) (*models.Response, error)
	Get_Tenant_appId(ctx context.Context, domain_uuid string) (*models.Response, error)
	Update_Tenant_details(ctx context.Context, domain_uuid string, flow map[string]interface{}) (*models.Response, error)
